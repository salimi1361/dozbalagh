...
@section('header_title', 'گزارش‌های لحظه‌ای و تحلیل وضعیت')

@section('content')
    <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
        @foreach(['صادر شده'=>'issued', 'در حال بررسی'=>'pending', 'لاشه تحویل شده'=>'collected', 'نیاز به اصلاح'=>'returned', 'تمدیدی'=>'renewed', 'مفقودی'=>'lost'] as $label => $key)
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <table class="w-full text-right text-xs">
            <thead class="bg-slate-100 text-slate-700">
                <tr>
                    <th class="p-4">کد راننده</th>
                    <th class="p-4">کد ناوگان</th>
