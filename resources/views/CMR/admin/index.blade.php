...
@section('content')
<div class="mb-4 flex flex-wrap gap-2" dir="rtl"><a href="{{ route('admin.cmr.master-data.index') }}" class="rounded-xl border px-4 py-2 font-bold">اطلاعات پایه e-CMR</a><a href="{{ route('admin.cmr.company-settings.index') }}" class="rounded-xl border px-4 py-2 font-bold">تنظیمات شرکت، شماره و چاپ</a></div>
<div class="space-y-5" dir="rtl">
    <div class="flex items-center justify-between"><div><h2 class="text-2xl font-black">اسناد e-CMR</h2><p class="text-sm text-slate-500">ماژول مستقل بارنامه الکترونیکی</p></div><div class="flex gap-2"><a href="{{ route('admin.cmr.company-settings.index') }}" class="rounded-xl border px-4 py-2 font-bold">تنظیمات شرکت و چاپ</a><a href="{{ route('admin.cmr.settings') }}" class="rounded-xl border px-4 py-2 font-bold">تعرفه</a><a href="{{ route('admin.cmr.create') }}" class="rounded-xl bg-sky-600 px-4 py-2 font-bold text-white">پیش‌نویس جدید</a></div></div>
