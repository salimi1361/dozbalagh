...
<body class="flex h-screen overflow-hidden">
    ...
    <main class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-4 sm:px-8 z-30 sticky top-0">
            <button onclick="toggleSidebar()" aria-label="باز و بسته کردن منو" aria-controls="sidebar" aria-expanded="true" class="p-2 text-slate-500 hover:bg-slate-100 rounded-lg">
